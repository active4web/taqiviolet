        ...
        builder: (context, state) {
          ...
          return Column(
            ...
            children: [
              ...
              InkWell(
                onTap: (){
                  showModalBottomSheet(context: context,isScrollControlled: true ,builder:(context)=> BlocConsumer<ReviewsCommentsCubit, ReviewsCommentsState>(
    listener: (context,state){
      if(state is ProductReviewSuccess){
        Navigator.pop(context);
                    ...
                    builder: (context, state) {
      return Padding(
        padding:  EdgeInsets.only(bottom:MediaQuery.of(context).viewInsets.bottom,right: 10.w,left: 10.w),
        child: Wrap(
          children: [
            Column(
                          children: [
                            SizedBox(height: 10.h,),
                            Center(child: Text('AddReview'.tr(),style: TextStyle(
                              fontWeight: FontWeight.bold,
                              fontSize: 16.sp,
                              color: kCustomBlack
                            ),)),
                            ...
                            if (cubit.images != null && cubit.images!.isNotEmpty)
                              SizedBox(
                            ...
                            SizedBox(height: 10.h,),
                            state is ProductReviewLoading?Center(child: CircularProgressIndicator()):
                            CustomButton(
                              height: 50.h,
                              text: 'AddReview'.tr(),
                              onTap: (){
                                cubit.addProductReview(id: widget.id);
                              },
                            ),
                            SizedBox(height: 10.h,)
                          ],
