...
class HoldingOrderListView extends StatelessWidget {
  const HoldingOrderListView({super.key});
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              //         fontWeight: FontWeight.bold
                              //     ),),
                              //     Expanded(child: Text(cubit.holdingOrderModel?.data?[index]??'',maxLines: 1,overflow: TextOverflow.ellipsis,)),
                              //   ],
                              // ),
