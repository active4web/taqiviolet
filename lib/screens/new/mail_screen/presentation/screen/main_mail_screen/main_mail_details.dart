                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          SizedBox(width: 20,),
                          Text(cubit.messageDetails?.data?.reserverName??''),
                        ],
                      ),
                      SizedBox(height: 10,),
                       ...
                       return Column(
                         ...
                         Padding(
                           ...
                           child: Sender(
                             ...
                             messageOwner:cubit.messageDetails?.data?.emails?[index].senderId==cubit.messageDetails?.data?.emails?[index].authId? "انا":cubit.messageDetails?.data?.reserverName??'',
