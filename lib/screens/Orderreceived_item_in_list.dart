...
class OrderReceivedItemInList extends StatefulWidget {
  @override
  _OrderReceivedItemInListState createState() =>
      _OrderReceivedItemInListState();
}

class _OrderReceivedItemInListState extends State<OrderReceivedItemInList> {
  @override
  Widget build(BuildContext context) {
    OrderReceivedItemInListCubit cubit =
        OrderReceivedItemInListCubit.get(context);
    //  cubit. state is OrderReceivedItemInListInitial ?cubit.getOrderReceivedData():log("hh");
    return SafeArea(
      child: Scaffold(
        appBar: CustomAppBar(title: "المنتجات"),
        body: BlocConsumer<OrderReceivedItemInListCubit,
            OrderReceivedItemInListState>(
