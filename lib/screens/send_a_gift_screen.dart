                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: Image.asset('assets/images/card.jpeg').image,fit: BoxFit.fill
                    )
                  ),child: Padding(
                    ...
                    Container(
                     ...
                     Padding(
                       padding:  EdgeInsets.only(top: 4.h,left: 20.0.w,right: 40.w,),
                       child: Column(
                         children: [
                           Row(mainAxisAlignment:MainAxisAlignment.center,children: [
                             Text("${"to".tr()}: ",style: TextStyle(fontWeight: FontWeight.bold),),
                             Expanded(child: Text(name??'',maxLines: 1,overflow: TextOverflow.ellipsis,))
                           ],),
                           SizedBox(height: 3.h,),
                           Row(mainAxisAlignment:MainAxisAlignment.center,children: [
                             Text("${"message".tr()}: ",style: TextStyle(fontWeight: FontWeight.bold),),
                             Expanded(child: Text(massge??'',maxLines: 3,overflow: TextOverflow.ellipsis,))
                           ],),
                         ],
                       ),
                     )
