    ...
    return BlocProvider(
      ...
      child: BlocConsumer<NewGiftsCubit, NewGiftsStates>(
        listener: (context, state) {
          //
          if(state is SendNewCardErrorState){
            ToastConfig.showToast(msg: "اعد المحاولة مرة اخرى", toastStates: ToastStates.warning);
          }
          if(state is SendNewCardSuccessState){
            ToastConfig.showToast(msg: "تم ارسال البطاقة بنجاح", toastStates: ToastStates.success);
