class NewOfferModel {
  ...
  String? errNum;
  String? msg;
  List<NewOfferModelData>? data;

  NewOfferModel({this.status, this.errNum, this.msg, this.data});
  ...
  NewOfferModel.fromJson(Map<String, dynamic> json) {
    ...
    msg = json['msg'];
    if (json['data'] != null) {
      data = <NewOfferModelData>[];
      json['data'].forEach((v) {
        data!.add(new NewOfferModelData.fromJson(v));
      });
    }
  }
...
class NewOfferModelData {
  ...
  NewOfferModelData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
